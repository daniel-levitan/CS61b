...
public class SpeciesListStage implements AdventureStage {
    ...
    public static double arraySimilarity(List<String> listOne, List<String> listTwo) {
        ...
        // Erro - Adicionei o caso onde não há elementos na lista 1, logo não pode haver nada igual
        if (listOne.size() == 0 || listTwo.size() == 0)
            return 0;
        // Essa função é retornada para um double, mas a divisão retorna um int
        // e assim perdemos precisão por arredondamento
